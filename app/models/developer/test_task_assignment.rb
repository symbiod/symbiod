...
module Developer
  ...
  class TestTaskAssignment < ApplicationRecord
    belongs_to :test_task, class_name: 'Developer::TestTask', foreign_key: 'test_task_id'
    belongs_to :test_task_result, class_name: 'Developer::TestTaskResult', foreign_key: 'test_task_result_id'
